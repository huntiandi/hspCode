...
* $直接拼接，\#会进行预编译，防止sql注入
* **sqlSessionFaction生命周期**：sqlSessionFactionBuilder
...
接口高并发如何处理，如何对接口限流，cloud基本概念，boot初始化类，sqlSessionFaction生命周期，分布式事务是否还有效，自定义异常，如何抛出异常，为什么有虚拟机，堆栈，如何开启一个线程，stream流，接口响应时间，二级缓存如何开启存在哪里，mysql如何创建索引
